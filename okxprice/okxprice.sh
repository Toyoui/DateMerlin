...
curl "https://www.okx.com/priapi/v1/nft/project/stats?urlName=this-song-about-nfts-4" -o merlinoff.json

curl "https://bridge.merlinchain.io/api/v1/tvl" -o tsanprice.json
